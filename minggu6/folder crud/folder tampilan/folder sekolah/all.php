...
<div style="clear:both;width:200px;margin-right:12px;" class="pull-right">
    <form action="index.php?p=sekolah&m=search">
        ...
        <input autocomplete="off" type="text" name="q" placeHolder="Type and enter to search" value="<?php echo ($_GET("q")); ?>">
    </form>
</div>
<div><?php echo $_GET('q') != "" ? "hasil pencarian untuk '" . ($_GET('q')) . "'" : ""; ?></div>
